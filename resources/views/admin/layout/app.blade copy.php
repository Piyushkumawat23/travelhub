        ...
        <nav class="app-header navbar navbar-expand bg-body">
            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav">
                    ...
                    {{--  @if (in_array('staffs.edit', $globalPermissions))
                      <li class="nav-item d-none d-md-block">
                          <a href="{{ route('staffs.edit', 1)}}" class="nav-link">Edit Staff</a>
                      </li>
                  @endif  --}}
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                        ...
                        {{-- Roles Menu Item --}}
                        @canany(['roles.view', 'roles.add']) {{-- Parent menu visible if any child link is visible --}}
                            <li class="nav-item">
                                <a href="#" class="nav-link">
                                    <i class="nav-icon bi bi-menu-button-wide"></i>
                                    <p>
